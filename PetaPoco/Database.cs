...
namespace PetaPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        {
            return Exists<T>(string.Format("{0}=:0", _dbType.EscapeSqlIdentifier(PocoData.ForType(typeof(T)).TableInfo.SecondaryKey)), secondaryKey);
        }
        ...
        {
            return Single<T>(string.Format("WHERE {0}=:0", _dbType.EscapeSqlIdentifier(PocoData.ForType(typeof(T)).TableInfo.SecondaryKey)), secondaryKey);
        }
        ...
        public string LastCommand
        {
            get
            {
                return FormatCommand(_lastSql, _lastArgs);
            }
        }
        #endregion
        ...
        {
            return FormatCommand(cmd.CommandText, (from IDataParameter parameter in cmd.Parameters
        ...
        internal void DoPreExecute(IDbCommand cmd)
        {
            ...
            _lastArgs = (from IDataParameter parameter in cmd.Parameters
                         select parameter.Value).ToArray();
        }
