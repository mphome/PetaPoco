...
namespace PetaPoco
{
    ...
    public class ColumnInfo
    {
        ...
        public static ColumnInfo FromProperty(PropertyInfo pi)
        {
            ...
            bool ExplicitColumns = pi.DeclaringType.GetCustomAttributes(typeof(ExplicitColumnsAttribute), true).Length
                                   > 0;
            ...
            if (ColAttrs.Length > 0)
            {
                ...
                if ((colattr as OnlyUpdateAttribute) != null)
                {
                    ci.UpdateOnly = true;
                }

                if ((colattr as OnlyInsertAttribute) != null)
                {
                    ci.InsertOnly = true;
                }
            }
